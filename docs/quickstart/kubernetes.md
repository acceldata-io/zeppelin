...
# Looking at the "./pom.xml" we can see the version is 0.11.2.3.3.6.1-SNAPSHOT
# Let's set the correct version in our Dockerfile:
# vi Dockerfile
# ARG version="0.11.2.3.3.6.1-SNAPSHOT"
# Once you saved the Dockerfile with the correct version we can build our image:
docker build -t zeppelin-server:0.11.2.3.3.6.1-SNAPSHOT -f ./Dockerfile .
```
...
docker build -t zeppelin-interpreter:0.11.2.3.3.6.1-SNAPSHOT -f ./Dockerfile .
```
...
zeppelin-interpreter          0.11.2.3.3.6.1-SNAPSHOT   4f77fe989eed   3 minutes ago    622MB
zeppelin-server               0.11.2.3.3.6.1-SNAPSHOT   4f77fe989eed   3 minutes ago    622MB
