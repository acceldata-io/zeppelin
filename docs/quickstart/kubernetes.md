...
# Looking at the "./pom.xml" we can see the version is 0.11.2.3.3.6.1-101
# Let's set the correct version in our Dockerfile:
# vi Dockerfile
# ARG version="0.11.2.3.3.6.1-101"
# Once you saved the Dockerfile with the correct version we can build our image:
docker build -t zeppelin-server:0.11.2.3.3.6.1-101 -f ./Dockerfile .
```
...
docker build -t zeppelin-interpreter:0.11.2.3.3.6.1-101 -f ./Dockerfile .
```
...
zeppelin-interpreter          0.11.2.3.3.6.1-101   4f77fe989eed   3 minutes ago    622MB
zeppelin-server               0.11.2.3.3.6.1-101   4f77fe989eed   3 minutes ago    622MB
